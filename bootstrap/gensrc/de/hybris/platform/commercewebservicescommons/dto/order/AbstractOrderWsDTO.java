...
@ApiModelProperty(name="deliveryTimeSlot") 	
...
@ApiModelProperty(name="chinesePaymentInfo", value="Chinese payment info") 	
...
@ApiModelProperty(name="paymentStatus", value="Payment status", example="PAID") 	
...
@ApiModelProperty(name="taxInvoice") 	
