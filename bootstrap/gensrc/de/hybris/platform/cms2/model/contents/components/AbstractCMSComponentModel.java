...
public class AbstractCMSComponentModel extends CMSItemModel
{
	...
	/**<i>Generated relation code constant for relation <code>CMSComponentChildrenForCMSComponent</code> defining source attribute <code>parents</code> in extension <code>cms2</code>.</i>*/
	...
	/** <i>Generated constant</i> - Attribute key of <code>AbstractCMSComponent.styleClasses</code> attribute defined at extension <code>cms2</code>. */
	...
	/** <i>Generated constant</i> - Attribute key of <code>AbstractCMSComponent.parents</code> attribute defined at extension <code>cms2</code>. */
	public static final String PARENTS = "parents";
	
	/** <i>Generated constant</i> - Attribute key of <code>AbstractCMSComponent.children</code> attribute defined at extension <code>cms2</code>. */
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>AbstractCMSComponent.children</code> attribute defined at extension <code>cms2</code>. 
	 * Consider using FlexibleSearchService::searchRelation for pagination support of large result sets.
	 * @return the children
	 */
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>AbstractCMSComponent.parents</code> attribute defined at extension <code>cms2</code>. 
	 * Consider using FlexibleSearchService::searchRelation for pagination support of large result sets.
	 * @return the parents
	 */
	...
	{
		return getPersistenceContext().getPropertyValue(PARENTS);
	}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>AbstractCMSComponent.styleClasses</code> attribute defined at extension <code>cms2</code>. 
	 * @return the styleClasses
	 */
	@Accessor(qualifier = "styleClasses", type = Accessor.Type.GETTER)
	public String getStyleClasses()
	{
		return getPersistenceContext().getPropertyValue(STYLECLASSES);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>AbstractCMSComponent.children</code> attribute defined at extension <code>cms2</code>. 
	 *  
	 * @param value the children
	 */
	@Accessor(qualifier = "children", type = Accessor.Type.SETTER)
	public void setChildren(final List<AbstractCMSComponentModel> value)
	{
	...
	/**
	 * <i>Generated method</i> - Setter of <code>AbstractCMSComponent.parents</code> attribute defined at extension <code>cms2</code>. 
	 *  
	 * @param value the parents
	 */
	@Accessor(qualifier = "parents", type = Accessor.Type.SETTER)
	public void setParents(final List<AbstractCMSComponentModel> value)
	{
	...
	/**
	 * <i>Generated method</i> - Setter of <code>AbstractCMSComponent.styleClasses</code> attribute defined at extension <code>cms2</code>. 
	 *  
	 * @param value the styleClasses
	 */
	@Accessor(qualifier = "styleClasses", type = Accessor.Type.SETTER)
	public void setStyleClasses(final String value)
	{
