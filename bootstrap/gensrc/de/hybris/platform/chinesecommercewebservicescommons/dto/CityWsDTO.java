...
@ApiModelProperty(name="isocode", value="ISO 3166-1 alpha-2 standard, e.g.[countryIso]-[regionNumber]-[cityNumber]", example="CN-11-1, CN-11-2, CN-11-3") 	
...
@ApiModelProperty(name="name", value="name of city", example="Beijing, Tianjin, Baoding") 	
	private String name;
