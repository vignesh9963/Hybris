...
public class AbstractAsConfigurableSearchConfigurationModel extends AbstractAsSearchConfigurationModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>AbstractAsConfigurableSearchConfiguration.groupMergeMode</code> attribute defined at extension <code>adaptivesearch</code>. */
	public static final String GROUPMERGEMODE = "groupMergeMode";
	
	/** <i>Generated constant</i> - Attribute key of <code>AbstractAsConfigurableSearchConfiguration.groupExpression</code> attribute defined at extension <code>adaptivesearch</code>. */
	public static final String GROUPEXPRESSION = "groupExpression";
	
	/** <i>Generated constant</i> - Attribute key of <code>AbstractAsConfigurableSearchConfiguration.groupLimit</code> attribute defined at extension <code>adaptivesearch</code>. */
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>AbstractAsConfigurableSearchConfiguration.groupExpression</code> attribute defined at extension <code>adaptivesearch</code>. 
	 * @return the groupExpression
	 */
	@Accessor(qualifier = "groupExpression", type = Accessor.Type.GETTER)
	public String getGroupExpression()
	{
		return getPersistenceContext().getPropertyValue(GROUPEXPRESSION);
	}
	
	/**
	 * <i>Generated method</i> - Getter of the <code>AbstractAsConfigurableSearchConfiguration.groupLimit</code> attribute defined at extension <code>adaptivesearch</code>. 
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>AbstractAsConfigurableSearchConfiguration.groupMergeMode</code> attribute defined at extension <code>adaptivesearch</code>. 
	 * @return the groupMergeMode
	 */
	@Accessor(qualifier = "groupMergeMode", type = Accessor.Type.GETTER)
	public AsGroupMergeMode getGroupMergeMode()
	{
		return getPersistenceContext().getPropertyValue(GROUPMERGEMODE);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>AbstractAsConfigurableSearchConfiguration.groupExpression</code> attribute defined at extension <code>adaptivesearch</code>. 
	 *  
	 * @param value the groupExpression
	 */
	@Accessor(qualifier = "groupExpression", type = Accessor.Type.SETTER)
	public void setGroupExpression(final String value)
	{
		getPersistenceContext().setPropertyValue(GROUPEXPRESSION, value);
	}
	
	/**
	 * <i>Generated method</i> - Setter of <code>AbstractAsConfigurableSearchConfiguration.groupLimit</code> attribute defined at extension <code>adaptivesearch</code>. 
	 *  
	...
	/**
	 * <i>Generated method</i> - Setter of <code>AbstractAsConfigurableSearchConfiguration.groupMergeMode</code> attribute defined at extension <code>adaptivesearch</code>. 
	 *  
	 * @param value the groupMergeMode
	 */
	@Accessor(qualifier = "groupMergeMode", type = Accessor.Type.SETTER)
	public void setGroupMergeMode(final AsGroupMergeMode value)
	{
		getPersistenceContext().setPropertyValue(GROUPMERGEMODE, value);
	}
