...
public class PreviewDataModel extends ItemModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>PreviewData.previewContentCatalogVersion</code> attribute defined at extension <code>cms2</code>. */
	...
	public PreviewDataModel(final ItemModel _owner)
	{
		super();
		setOwner(_owner);
	}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>PreviewData.previewContentCatalogVersion</code> attribute defined at extension <code>cms2</code>. 
	 * @return the previewContentCatalogVersion
	 */
	...
	{
		return getPersistenceContext().getPropertyValue(PREVIEWCONTENTCATALOGVERSION);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>PreviewData.previewContentCatalogVersion</code> attribute defined at extension <code>cms2</code>. 
	 *  
	 * @param value the previewContentCatalogVersion
	 */
	@Accessor(qualifier = "previewContentCatalogVersion", type = Accessor.Type.SETTER)
	public void setPreviewContentCatalogVersion(final CatalogVersionModel value)
	{
