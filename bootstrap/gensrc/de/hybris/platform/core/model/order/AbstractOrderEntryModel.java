...
public class AbstractOrderEntryModel extends ItemModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>AbstractOrderEntry.selectedCheck</code> attribute defined at extension <code>icxtrainingcore</code>. */
	public static final String SELECTEDCHECK = "selectedCheck";
	...
	/** <i>Generated constant</i> - Attribute key of <code>AbstractOrderEntry.productConfiguration</code> attribute defined at extension <code>sapproductconfigservices</code>. */
	public static final String PRODUCTCONFIGURATION = "productConfiguration";
	
	/** <i>Generated constant</i> - Attribute key of <code>AbstractOrderEntry.productConfigurationDraft</code> attribute defined at extension <code>sapproductconfigservices</code>. */
	public static final String PRODUCTCONFIGURATIONDRAFT = "productConfigurationDraft";
	
	/** <i>Generated constant</i> - Attribute key of <code>AbstractOrderEntry.addToCartTime</code> attribute defined at extension <code>selectivecartservices</code>. */
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>AbstractOrderEntry.addToCartTime</code> attribute defined at extension <code>selectivecartservices</code>. 
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>AbstractOrderEntry.cpqStatusSummaryMap</code> attribute defined at extension <code>sapproductconfigservices</code>. 
	 * @return the cpqStatusSummaryMap - Status of the configuration and number of errors.
	 */
	@Accessor(qualifier = "cpqStatusSummaryMap", type = Accessor.Type.GETTER)
	public Map<ProductInfoStatus,Integer> getCpqStatusSummaryMap()
	{
		return getPersistenceContext().getPropertyValue(CPQSTATUSSUMMARYMAP);
	}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>AbstractOrderEntry.productConfiguration</code> attribute defined at extension <code>sapproductconfigservices</code>. 
	 * @return the productConfiguration - Active Product Configuration.
	 */
	@Accessor(qualifier = "productConfiguration", type = Accessor.Type.GETTER)
	public ProductConfigurationModel getProductConfiguration()
	{
		return getPersistenceContext().getPropertyValue(PRODUCTCONFIGURATION);
	}
	
	/**
	 * <i>Generated method</i> - Getter of the <code>AbstractOrderEntry.productConfigurationDraft</code> attribute defined at extension <code>sapproductconfigservices</code>. 
	 * @return the productConfigurationDraft - ProductConfiguration Draft.
	 */
	@Accessor(qualifier = "productConfigurationDraft", type = Accessor.Type.GETTER)
	public ProductConfigurationModel getProductConfigurationDraft()
	{
		return getPersistenceContext().getPropertyValue(PRODUCTCONFIGURATIONDRAFT);
	}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>AbstractOrderEntry.selectedCheck</code> attribute defined at extension <code>icxtrainingcore</code>. 
	 * @return the selectedCheck
	 */
	@Accessor(qualifier = "selectedCheck", type = Accessor.Type.GETTER)
	public Boolean getSelectedCheck()
	{
		return getPersistenceContext().getPropertyValue(SELECTEDCHECK);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>AbstractOrderEntry.cpqStatusSummaryMap</code> attribute defined at extension <code>sapproductconfigservices</code>. 
	 *  
	 * @param value the cpqStatusSummaryMap - Status of the configuration and number of errors.
	 */
	@Accessor(qualifier = "cpqStatusSummaryMap", type = Accessor.Type.SETTER)
	public void setCpqStatusSummaryMap(final Map<ProductInfoStatus,Integer> value)
	{
		getPersistenceContext().setPropertyValue(CPQSTATUSSUMMARYMAP, value);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>AbstractOrderEntry.productConfiguration</code> attribute defined at extension <code>sapproductconfigservices</code>. 
	 *  
	 * @param value the productConfiguration - Active Product Configuration.
	 */
	@Accessor(qualifier = "productConfiguration", type = Accessor.Type.SETTER)
	public void setProductConfiguration(final ProductConfigurationModel value)
	{
		getPersistenceContext().setPropertyValue(PRODUCTCONFIGURATION, value);
	}
	
	/**
	 * <i>Generated method</i> - Setter of <code>AbstractOrderEntry.productConfigurationDraft</code> attribute defined at extension <code>sapproductconfigservices</code>. 
	 *  
	 * @param value the productConfigurationDraft - ProductConfiguration Draft.
	 */
	@Accessor(qualifier = "productConfigurationDraft", type = Accessor.Type.SETTER)
	public void setProductConfigurationDraft(final ProductConfigurationModel value)
	{
		getPersistenceContext().setPropertyValue(PRODUCTCONFIGURATIONDRAFT, value);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>AbstractOrderEntry.selectedCheck</code> attribute defined at extension <code>icxtrainingcore</code>. 
	 *  
	 * @param value the selectedCheck
	 */
	@Accessor(qualifier = "selectedCheck", type = Accessor.Type.SETTER)
	public void setSelectedCheck(final Boolean value)
	{
		getPersistenceContext().setPropertyValue(SELECTEDCHECK, value);
	}
