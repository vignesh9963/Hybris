...
public class ClassificationClassModel extends CategoryModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>ClassificationClass.classFeatureGroups</code> attribute defined at extension <code>classificationgroupsservices</code>. */
	public static final String CLASSFEATUREGROUPS = "classFeatureGroups";
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>ClassificationClass.classFeatureGroups</code> attribute defined at extension <code>classificationgroupsservices</code>. 
	 * Consider using FlexibleSearchService::searchRelation for pagination support of large result sets.
	 * @return the classFeatureGroups
	 */
	@Accessor(qualifier = "classFeatureGroups", type = Accessor.Type.GETTER)
	public List<ClassFeatureGroupModel> getClassFeatureGroups()
	{
		return getPersistenceContext().getPropertyValue(CLASSFEATUREGROUPS);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>ClassificationClass.classFeatureGroups</code> attribute defined at extension <code>classificationgroupsservices</code>. 
	 *  
	 * @param value the classFeatureGroups
	 */
	@Accessor(qualifier = "classFeatureGroups", type = Accessor.Type.SETTER)
	public void setClassFeatureGroups(final List<ClassFeatureGroupModel> value)
	{
		getPersistenceContext().setPropertyValue(CLASSFEATUREGROUPS, value);
	}
