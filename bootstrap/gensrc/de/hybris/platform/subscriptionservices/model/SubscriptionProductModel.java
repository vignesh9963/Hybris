...
public class SubscriptionProductModel extends ProductModel
{
	...
	public static final String _TYPECODE = "SubscriptionProduct";
	 ...
	 */
	public SubscriptionProductModel(final ItemModelContext ctx)
	{
		super(ctx);
	}
	...
	public SubscriptionProductModel(final CatalogVersionModel _catalogVersion, final String _code)
	{
		super();
	 ...
	 */
	@Deprecated(since = "4.1.1", forRemoval = true)
	public SubscriptionProductModel(final CatalogVersionModel _catalogVersion, final String _code, final ItemModel _owner)
	{
		super();
		setCatalogVersion(_catalogVersion);
		setCode(_code);
