...
public class SecureConfigurationViewServiceFunctionalTest
{
	...
	public void shouldAllowAllIfNothingBlacklisted()
	{
		...
		final ConfigurationViewService viewService = new SecureConfigurationViewService(() -> envVariables,
	...
	public void shouldApplyMultiBlacklist()
	{
		...
		// then
		final Map<String, String> expected = copyMapWithoutEntries(mergedProperties, "db.username", "db.password",
				"y_db_username", "y_db_password");
		assertThat(safeProperties).containsOnly(asEntryArray(expected));
	}
	...
	{
		// given
		regexRules = ImmutableMap.of("configuration.view.regex.rule.test.password",
				"^[^0-9]+password$"); // ignoring uppercase test data, they are not a subject of this test
	...
	public void shouldApplyEdgeRegex()
	{
		...
		regexRules = ImmutableMap.<String, String>builder() //
		                                                    ...
		                                                    .put("configuration.view.regex.rule.test.types.nonexistent",
				                                                    "nonexistent")
