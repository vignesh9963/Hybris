...
public class BackofficeSavedQueryModel extends ItemModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>BackofficeSavedQuery.savedQueriesParameters</code> attribute defined at extension <code>platformbackoffice</code>. */
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>BackofficeSavedQuery.savedQueriesParameters</code> attribute defined at extension <code>platformbackoffice</code>. 
	 * @return the savedQueriesParameters
	 */
	@Accessor(qualifier = "savedQueriesParameters", type = Accessor.Type.GETTER)
	public Map<String,String> getSavedQueriesParameters()
	{
		return getPersistenceContext().getPropertyValue(SAVEDQUERIESPARAMETERS);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>BackofficeSavedQuery.savedQueriesParameters</code> attribute defined at extension <code>platformbackoffice</code>. 
	 *  
	 * @param value the savedQueriesParameters
	 */
	@Accessor(qualifier = "savedQueriesParameters", type = Accessor.Type.SETTER)
	public void setSavedQueriesParameters(final Map<String,String> value)
	{
